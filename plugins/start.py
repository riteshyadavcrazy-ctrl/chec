...
async def terms(client, message):
    ...
    buttons = InlineKeyboardMarkup([[InlineKeyboardButton("📋 See Plans", callback_data="see_plan")]])
...
async def plan(client, message):
    ...
    buttons = InlineKeyboardMarkup([[InlineKeyboardButton("📜 See Terms", callback_data="see_terms")]])
